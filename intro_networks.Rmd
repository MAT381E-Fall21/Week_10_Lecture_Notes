...
# Networks
- **Network analysis** is a suite of tools/methods developed to understand and analyze network graphs where **vertices** (nodes) connected through  **edges**.
- With an example from Facebook, we can consider **vertices** are **users** and **edges** are **friendships**.
...
- "In the real world, however, **jobs and sectors are linked**. Displaced workers can often transition to another job or sector requiring similar skills."
